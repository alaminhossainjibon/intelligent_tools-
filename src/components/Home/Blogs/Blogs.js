...
const Blogs = () => {
    return (
        <div className='container mx-auto'>
            <h2 className='text-center text-4xl font-bold my-6 text-purple-600'>This my is Blogs!!</h2>

            <div tabindex="0" class="my-4 collapse collapse-plus border border-success bg-base-100 rounded-box">
